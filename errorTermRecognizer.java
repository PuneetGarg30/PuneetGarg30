...
public class ErrorTermRecognizer {
	...
	public static String checkErrorTerm(String input) {
		...
		while (running) {
			...
			case 5: 
				...
				// In state 5, if the character is 0 through 9, it is accepted and we stay in this
				// state
			...
			case 6: 
				...
				// In state 6, if the character is 0 through 9, it is accepted and we stay in this
				// state
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
			...
			case 7: 
				...
				// In state 7, if the character is 0 through 9, it is accepted and we stay in this
				// state
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
		...
		case 8: 
         // State 8 has one valid transitions.  Each is addressed by an if statement.
			...
			// In state 8, if the character is ., it is accepted and we stay in this
			// state
			if (currentChar == '.' ) {
				nextState = 9;
				break;
	...
	case 9: 
         // State 9 has one valid transitions.  Each is addressed by an if statement.
		 
		 // This is a final state
		finalState = false;
		
		// In state 1, if the character is 1 through 9, it is accepted and we stay in this
		// state
		if (currentChar >= '1' && currentChar <= '9') {
			nextState = 4;
			break;
		...
		case 9:	
		case 3:
			// States 3, and 9 are the same. None of them are final states and in order to
						// move forward, the next character must be a digit.
						errorTermErrorMessage = "This character may only be a digit.\n";
						return errorTermErrorMessage + displayInput(input, currentCharNdx);

		case 6:
			// States 6 is not a final states and in order to
			// move forward, the next character must be a digit.
			errorTermErrorMessage = "This character may only be a digit.\n";
			return errorTermErrorMessage + displayInput(input, currentCharNdx);
